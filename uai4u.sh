...
gui() {
    ...
    *)
        clear
        echo "Digite [ubuntu] se usa gnome/unitym [kubuntu] se usa kde ou [xubuntu] se usa xfce!"
        sleep 3
        clear
        gui
        ;;
...
temas() {
    ...
    *)
        clear
        echo "Digite [sim] se deseja instalar os temas ou [nao] para finalizar o processo!"
        sleep 3
        clear
        temas
        ;;
...
chrome() {
    ...
    *)
        clear
        echo "Digite [sim] se deseja instalar o google-chrome ou [nao] para finalizar o processo!"
        sleep 3
        clear
        chrome
        ;;
